...
Теперь вы знаете основы того, что делает hypothesis, остальное в документации поможет вам понять, как и почему. Она разделена на
разделы, которые вы можете увидеть в боковой панели (или в верхней части меню, если вы на мобильном телефоне). Но вероятнее всего,  вы хотите начать с: doc:`Краткого руководства по началу работы <quickstart>`, которое даст вам работющие примеры использования hypothesis и подробный план того, что вам нужно знать, чтобы начать тестирование кода с ним, или проверить некоторые из `introductory articles <http://hypothesis.works/articles/intro/>`_.
